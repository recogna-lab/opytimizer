...
def test_tree_space_n_terminals():
    new_tree_space = tree.TreeSpace(1, 1, 1, 0, 1)
...
def test_tree_space_n_terminals_setter():
    try:
        new_tree_space = tree.TreeSpace(1, 1, 1, 0, 1, n_terminals=0.0)
    except:
        new_tree_space = tree.TreeSpace(1, 1, 1, 0, 1, n_terminals=1)

    try:
        new_tree_space = tree.TreeSpace(1, 1, 1, 0, 1, n_terminals=0)
    except:
        new_tree_space = tree.TreeSpace(1, 1, 1, 0, 1, n_terminals=1)
...
def test_tree_space_min_depth_setter():
    try:
        new_tree_space = tree.TreeSpace(1, 1, 1, 0, 1, min_depth=0.0)
    except:
        new_tree_space = tree.TreeSpace(1, 1, 1, 0, 1, min_depth=1)

    try:
        new_tree_space = tree.TreeSpace(1, 1, 1, 0, 1, min_depth=0)
    except:
        new_tree_space = tree.TreeSpace(1, 1, 1, 0, 1, min_depth=1)
...
def test_tree_space_max_depth():
    new_tree_space = tree.TreeSpace(1, 1, 1, 0, 1, max_depth=1)
...
def test_tree_space_max_depth_setter():
    try:
        new_tree_space = tree.TreeSpace(1, 1, 1, 0, 1, max_depth=0.0)
    except:
        new_tree_space = tree.TreeSpace(1, 1, 1, 0, 1, max_depth=1)

    try:
        new_tree_space = tree.TreeSpace(1, 1, 1, 0, 1, max_depth=0)
    except:
        new_tree_space = tree.TreeSpace(1, 1, 1, 0, 1, max_depth=1)
...
def test_tree_space_functions():
    new_tree_space = tree.TreeSpace(1, 1, 1, 0, 1, functions=["SUM"])
...
def test_tree_space_functions_setter():
    try:
        new_tree_space = tree.TreeSpace(1, 1, 1, 0, 1, functions="a")
    except:
        new_tree_space = tree.TreeSpace(1, 1, 1, 0, 1, functions=["SUM"])
...
def test_tree_space_create_terminals():
    new_tree_space = tree.TreeSpace(1, 1, 1, 0, 1, n_terminals=2)
...
def test_tree_space_create_trees():
    new_tree_space = tree.TreeSpace(2, 1, 1, 0, 1)
...
def test_tree_space_grow():
    new_tree_space = tree.TreeSpace(
        1, 1, 1, 0, 1, min_depth=1, max_depth=5, functions=["SUM", "SUB", "MUL", "DIV"]
    )
