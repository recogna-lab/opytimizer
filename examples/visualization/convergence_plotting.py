...
de = DE()
opt_de = Opytimizer(space=space, optimizer=de, function=func, save_agents=False, save_history=True)
...
space = SearchSpace(n_agents=N_AGENTS, n_variables=n_variables, n_objectives=n_objectives, lower_bound=lower_bound, upper_bound=upper_bound)
pso = PSO()
opt_pso = Opytimizer(space=space, optimizer=pso, function=func, save_agents=False, save_history=True)
...
space = SearchSpace(n_agents=N_AGENTS, n_variables=n_variables, n_objectives=n_objectives, lower_bound=lower_bound, upper_bound=upper_bound)
gwo = GWO()
opt_gwo = Opytimizer(space=space, optimizer=gwo, function=func, save_agents=False, save_history=True)
