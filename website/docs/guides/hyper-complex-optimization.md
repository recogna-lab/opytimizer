---
sidebar_position: 6
title: Hyper-Complex Optimization
---

# Hyper-Complex Search Space Optimization

Optimize problems in hyper-complex spaces using quaternions or octonions with `HyperComplexSpace` and spanning decorators.
